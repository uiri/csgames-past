...
public final class ASelectionNamedExpression extends PNamedExpression
{
    ...
    public ASelectionNamedExpression()
    {
        // Constructor
    }

    public ASelectionNamedExpression(
        @SuppressWarnings("hiding") List<TIdentifier> _names_,
        @SuppressWarnings("hiding") TAssign _assign_,
        @SuppressWarnings("hiding") TIdentifier _selectorName_,
    ...
    public Object clone()
    {
        return new ASelectionNamedExpression(
            cloneList(this._names_),
            cloneNode(this._assign_),
            cloneNode(this._selectorName_),
            cloneNode(this._parameter_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseASelectionNamedExpression(this);
    }
