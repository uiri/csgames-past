...
public final class ANumberManyOperator extends PManyOperator
{
    private TCaret _caret_;
    private TNumber _number_;

    public ANumberManyOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumberManyOperator(
    ...
    {
        ((Analysis) sw).caseANumberManyOperator(this);
    }
