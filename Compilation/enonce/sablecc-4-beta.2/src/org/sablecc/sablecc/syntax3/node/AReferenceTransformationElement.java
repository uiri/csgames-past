...
public final class AReferenceTransformationElement extends PTransformationElement
{
    private PElementReference _elementReference_;

    public AReferenceTransformationElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceTransformationElement(
            cloneNode(this._elementReference_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAReferenceTransformationElement(this);
    }
