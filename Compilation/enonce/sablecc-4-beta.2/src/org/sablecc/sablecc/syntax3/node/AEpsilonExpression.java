...
public final class AEpsilonExpression extends PExpression
{
    private TEpsilon _epsilon_;

    public AEpsilonExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilonExpression(
            cloneNode(this._epsilon_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAEpsilonExpression(this);
    }
