...
public final class ARejectLexerAction extends PLexerAction
{
    private TString _token_;

    public ARejectLexerAction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARejectLexerAction(
            cloneNode(this._token_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseARejectLexerAction(this);
    }
