...
public final class AIgnoreLexerAction extends PLexerAction
{
    private TString _token_;

    public AIgnoreLexerAction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIgnoreLexerAction(
            cloneNode(this._token_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIgnoreLexerAction(this);
    }
