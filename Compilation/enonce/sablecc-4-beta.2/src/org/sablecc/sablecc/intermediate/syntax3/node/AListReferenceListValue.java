...
public final class AListReferenceListValue extends PListValue
{
    private TString _parseElement_;
    private TString _retainedElement_;

    public AListReferenceListValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListReferenceListValue(
    ...
    {
        ((Analysis) sw).caseAListReferenceListValue(this);
    }
