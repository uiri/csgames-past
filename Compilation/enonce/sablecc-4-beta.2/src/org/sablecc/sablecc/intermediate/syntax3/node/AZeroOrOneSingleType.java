...
public final class AZeroOrOneSingleType extends PSingleType
{
    private TString _unit_;
    private PBoolean _public_;

    public AZeroOrOneSingleType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AZeroOrOneSingleType(
    ...
    {
        ((Analysis) sw).caseAZeroOrOneSingleType(this);
    }
