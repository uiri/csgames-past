...
public final class ATextInsertMacroPart extends PMacroPart
{
    private PTextInsert _textInsert_;

    public ATextInsertMacroPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATextInsertMacroPart(
            cloneNode(this._textInsert_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATextInsertMacroPart(this);
    }
