...
public final class AIntermediateRepresentation extends PIntermediateRepresentation
{
    ...
    public AIntermediateRepresentation(
        @SuppressWarnings("hiding") List<PText> _texts_,
        @SuppressWarnings("hiding") List<PMacro> _macros_)
    {
        // Constructor
        setTexts(_texts_);
    ...
    public Object clone()
    {
        return new AIntermediateRepresentation(
            cloneList(this._texts_),
            cloneList(this._macros_));
    }
    ...
    {
        return ""
            + toString(this._texts_)
            + toString(this._macros_);
    }
