...
public final class AEscapeTextBlockBodyPart extends PTextBlockBodyPart
{
    private TEscape _escape_;

    public AEscapeTextBlockBodyPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEscapeTextBlockBodyPart(
            cloneNode(this._escape_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAEscapeTextBlockBodyPart(this);
    }
