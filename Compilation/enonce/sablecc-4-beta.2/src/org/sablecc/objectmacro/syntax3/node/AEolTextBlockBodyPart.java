...
public final class AEolTextBlockBodyPart extends PTextBlockBodyPart
{
    private TEol _eol_;

    public AEolTextBlockBodyPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEolTextBlockBodyPart(
            cloneNode(this._eol_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAEolTextBlockBodyPart(this);
    }
