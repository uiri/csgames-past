...
public final class ATextBlock extends PTextBlock
{
    private TIdentifier _name_;
    private final LinkedList<PParam> _params_ = new LinkedList<PParam>();
    private final LinkedList<PTextBlockBodyPart> _parts_ = new LinkedList<PTextBlockBodyPart>();
    ...
    public ATextBlock(
        ...
        @SuppressWarnings("hiding") List<PTextBlockBodyPart> _parts_,
    ...
    {
        ((Analysis) sw).caseATextBlock(this);
    }
    ...
    public LinkedList<PTextBlockBodyPart> getParts()
    {
        return this._parts_;
    }

    public void setParts(List<PTextBlockBodyPart> list)
    {
        this._parts_.clear();
        this._parts_.addAll(list);
        for(PTextBlockBodyPart e : list)
        {
            if(e.parent() != null)
            {
                e.parent().removeChild(e);
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PTextBlockBodyPart> i = this._parts_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
                {
                    i.set((PTextBlockBodyPart) newChild);
                    newChild.parent(this);
                    oldChild.parent(null);
                    return;
                }
