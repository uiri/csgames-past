...
public final class ATextInsertMacroBodyPart extends PMacroBodyPart
{
    private PTextInsert _textInsert_;

    public ATextInsertMacroBodyPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATextInsertMacroBodyPart(
            cloneNode(this._textInsert_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATextInsertMacroBodyPart(this);
    }
