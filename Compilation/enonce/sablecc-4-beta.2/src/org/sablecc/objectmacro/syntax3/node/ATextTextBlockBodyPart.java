...
public final class ATextTextBlockBodyPart extends PTextBlockBodyPart
{
    private TText _text_;

    public ATextTextBlockBodyPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATextTextBlockBodyPart(
            cloneNode(this._text_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATextTextBlockBodyPart(this);
    }
