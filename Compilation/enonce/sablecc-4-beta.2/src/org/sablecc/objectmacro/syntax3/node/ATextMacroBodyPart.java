...
public final class ATextMacroBodyPart extends PMacroBodyPart
{
    private TText _text_;

    public ATextMacroBodyPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATextMacroBodyPart(
            cloneNode(this._text_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATextMacroBodyPart(this);
    }
